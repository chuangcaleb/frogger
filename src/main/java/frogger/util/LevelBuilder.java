...
public enum LevelBuilder {
		...
		return new ArrayList<>() {
			{
				...
				addAll(LaneBuilder.INSTANCE.construct("Car", 4, new int[]{0,45,80}, 8));
				addAll(LaneBuilder.INSTANCE.construct("Car", -2, new int[]{10,40,85}, 9));
				addAll(LaneBuilder.INSTANCE.construct("Car", -3, new int[]{0,50,75}, 10));
		...
		return new ArrayList<>() {
			{
				...
				addAll(LaneBuilder.INSTANCE.construct("ShortTruck", -4, new int[]{25,75}, 7));
				addAll(LaneBuilder.INSTANCE.construct("Car", 4, new int[]{0,30,50,75}, 8));
				addAll(LaneBuilder.INSTANCE.construct("Car", -3, new int[]{15,40,90}, 9));
				addAll(LaneBuilder.INSTANCE.construct("Car", -4, new int[]{10,40,50,85}, 10));
				addAll(LaneBuilder.INSTANCE.construct("Car", 3, new int[]{10,25,50,80}, 11));
			}
		};
	}
		...
		return new ArrayList<>() {
			{
				...
				addAll(LaneBuilder.INSTANCE.construct("Car", 5, new int[]{0,30,50,75}, 7));
				addAll(LaneBuilder.INSTANCE.construct("ShortTruck", -3, new int[]{35,50,85}, 8));
				addAll(LaneBuilder.INSTANCE.construct("Car", 6, new int[]{0,22,40,75}, 9));
				addAll(LaneBuilder.INSTANCE.construct("Car", -4, new int[]{30,50,75,90}, 10));
				addAll(LaneBuilder.INSTANCE.construct("ShortTruck", 3, new int[]{0,40,75}, 11));
			}
		};
	}
			...
			return new ArrayList<>() {
				{
					...
					addAll(LaneBuilder.INSTANCE.construct("Car", -6, new int[]{0,30,55,70}, 7));
					addAll(LaneBuilder.INSTANCE.construct("Car", 6, new int[]{0,50,75}, 8));
					addAll(LaneBuilder.INSTANCE.construct("ShortTruck", 5, new int[]{0,40,75}, 9));
					addAll(LaneBuilder.INSTANCE.construct("ShortTruck", -4, new int[]{0,50,75}, 10));
					addAll(LaneBuilder.INSTANCE.construct("Car", 4, new int[]{0,30,50,75}, 11));
				}
			};
		}
	...
	private ArrayList<AutoActor> buildLevelFive() {
				return new ArrayList<>() {
					{
						addAll(LaneBuilder.INSTANCE.construct("MedLog", 4, new int[]{0,33,67}, 1));
						...
						addAll(LaneBuilder.INSTANCE.construct("Car", 6, new int[]{0,30,55,70}, 7));
						addAll(LaneBuilder.INSTANCE.construct("LongTruck", -4, new int[]{20,53,86}, 8));
						addAll(LaneBuilder.INSTANCE.construct("Car", -5, new int[]{0,25,40,75}, 9));
						addAll(LaneBuilder.INSTANCE.construct("ShortTruck", 5, new int[]{20,60,95}, 10));
						addAll(LaneBuilder.INSTANCE.construct("Car", 6, new int[]{0,40,60,80}, 11));
					}
				};
			}
